...
class PendingOperation(BaseOperation):
        ...
        default=False,
        metadata={"marshmallow_field": fields.Boolean(required=True, metadata={"const": False})},
    )
...
class CompletedOperation(BaseOperation):
    response: dict
        ...
        default=True,
        metadata={"marshmallow_field": fields.Boolean(required=True, metadata={"const": True})},
    )
